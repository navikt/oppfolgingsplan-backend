package no.nav.syfo.auth.tokenx.tokendings
...
import no.nav.syfo.auth.tokenx.TokenXResponse
import no.nav.syfo.auth.tokenx.toTokenXToken
...
@Component
class TokenDingsConsumer @Autowired constructor(
